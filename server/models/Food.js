...
const foodSchema = new mongoose.Schema(
  {
    ...
    category: {
      ...
      enum: {
        values: ['Prepared Meals', 'Bakery & Pastries', 'Catering Surplus', 'Groceries & Produce', 'Beverages', 'Other'],
    ...
    image: {
      type: String,
      default: 'https://images.unsplash.com/photo-1555396273-367ea4eb4db5?auto=format&fit=crop&w=1000&q=80',
    },
    status: {
      type: String,
      enum: ['AVAILABLE', 'EXPIRING_SOON', 'ALMOST_EXPIRED', 'SOLD_OUT', 'EXPIRED'],
      default: 'AVAILABLE',
      uppercase: true,
    },
  },
