...
import { PageHeader, Card, Button, Input, Select } from '../../components/common';
  ...
  return (
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
      ...
      <PageHeader
        ...
        actions={
          <Button variant="primary" iconLeft={CheckCircle2} onClick={handleSaveSettings}>
      ...
      <div className="space-y-8">
        ...
        <Card variant="default">
          <div className="flex items-center gap-2 pb-4 mb-4 border-b border-charcoal-100">
            ...
            <div>
              <Card.Title className="text-base">1. Account & Security</Card.Title>
              <Card.Description>Manage authentication and password security</Card.Description>
            </div>
          </div>
          ...
          <div className="space-y-4 text-xs">
            <div className="flex flex-col sm:flex-row sm:items-center justify-between p-4 bg-surface-50 rounded-2xl border border-charcoal-100 gap-3">
              <div>
                <p className="font-bold text-charcoal-900 text-sm">Primary Email Address</p>
                <p className="text-charcoal-600 mt-0.5">{currentUser?.email || 'partner@replate.org'}</p>
              </div>
            ...
            <div className="flex flex-col sm:flex-row sm:items-center justify-between p-4 bg-surface-50 rounded-2xl border border-charcoal-100 gap-3">
              <div>
                <p className="font-bold text-charcoal-900 text-sm">Password Security</p>
                <p className="text-charcoal-600 mt-0.5">Send a Firebase password reset email</p>
                {resetFeedback && (
                  <p className="text-emerald-700 font-bold mt-1">{resetFeedback}</p>
                )}
              </div>
              <Button
                size="sm"
        ...
        <Card variant="default">
          <div className="flex items-center gap-2 pb-4 mb-4 border-b border-charcoal-100">
            ...
            <div>
              <Card.Title className="text-base">2. Notifications & Surplus Alerts</Card.Title>
              <Card.Description>Configure how and when you receive food recovery alerts</Card.Description>
            </div>
          </div>
            ...
            {[
              ...
              >
                <div className="flex items-start gap-3 pr-4">
                  ...
                  <div>
                    <p className="font-bold text-charcoal-900 text-sm">{item.title}</p>
        ...
        <Card variant="default">
          <div className="flex items-center gap-2 pb-4 mb-4 border-b border-charcoal-100">
            ...
            <div>
              <Card.Title className="text-base">3. Privacy & Directory Controls</Card.Title>
              <Card.Description>Manage organization visibility across the RePlate network</Card.Description>
            </div>
          </div>
        ...
        <Card variant="default">
          <div className="flex items-center gap-2 pb-4 mb-4 border-b border-charcoal-100">
            ...
            <div>
              <Card.Title className="text-base">4. Regional & Application Preferences</Card.Title>
              <Card.Description>Default location settings and units</Card.Description>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <Select
              ...
              onChange={(e) => setPreferences({ ...preferences, maxRadius: e.target.value })}
              options={[
                { value: '2', label: '2 km' },
                { value: '5', label: '5 km' },
