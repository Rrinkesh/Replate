...
import { CheckCircle2, Clock, AlertTriangle, BadgeCheck, Sparkles } from 'lucide-react';
  ...
  return (
    ...
    >
      ...
      {showIcon && IconComponent && (
        <IconComponent className={`shrink-0 ${size === 'sm' ? 'w-3 h-3' : size === 'lg' ? 'w-4 h-4' : 'w-3.5 h-3.5'}`} />
      )}
