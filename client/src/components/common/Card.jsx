...
const variantClasses = {
  default: 'bg-white border border-charcoal-100 shadow-soft-sm hover:shadow-soft-md',
...
Card.Title = ({ children, className = '', as: Component = 'h3', ...props }) => (
  <Component className={`text-base sm:text-lg font-extrabold text-charcoal-900 tracking-tight ${className}`} {...props}>
    {children}
  </Component>
);

Card.Description = ({ children, className = '', ...props }) => (
  <p className={`text-xs sm:text-sm text-charcoal-500 mt-1 leading-relaxed ${className}`} {...props}>
    {children}
  </p>
);
...
Card.Footer = ({ children, className = '', ...props }) => (
  <div className={`mt-6 pt-4 border-t border-charcoal-100 flex items-center justify-between gap-3 ${className}`} {...props}>
    {children}
  </div>
);
