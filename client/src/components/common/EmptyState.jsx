...
const EmptyState = ({
  ...
  return (
    <div className={`flex flex-col items-center justify-center text-center p-8 sm:p-12 bg-white rounded-3xl border border-charcoal-100 shadow-soft-sm ${className}`}>
